...
#[properties(wrapper_type = super::SymbolListBoxRow)]
pub struct SymbolListBoxRow {
    #[property(get, set, construct_only)]
    symbol: RefCell<Option<Symbol>>,
}

#[glib::object_subclass]
impl ObjectSubclass for SymbolListBoxRow {
    const NAME: &'static str = "SymbolListBoxRow";
    type ParentType = gtk::ListBoxRow;
    type Type = super::SymbolListBoxRow;
}

impl ObjectImpl for SymbolListBoxRow {
...
impl WidgetImpl for SymbolListBoxRow {}
impl ListBoxRowImpl for SymbolListBoxRow {}
